"""
strategy_backtesting_gross1_best_oos.py
==============================
...
OUTPUT_DIR               = os.path.join(_SCRIPT_DIR, '..', 'FINAL - strategy_outcomes')
...
# Paths
# ─────────────────────────────────────────────────────────────────────────────
PATH_VAL_R2    = os.path.join(_OUT_DIR, "model_selection_results_val_r2.csv")
PATH_OOS_R2    = os.path.join(_OUT_DIR, "model_selection_results_oos_r2.csv")
PATH_PRED_TEST = os.path.join(_OUT_DIR, "y_pred_test.csv")
PATH_PRED_VAL  = os.path.join(_OUT_DIR, "y_pred_val.csv")
PATH_PANEL     = os.path.join(_DATA_DIR, "merged_daily_panel_fedincl_nextday.csv")
PATH_RF        = os.path.join(_DATA_DIR, "rf_return.csv")
...
for asset in base_assets:
    ...
    ax.set_title(f"Cumulative Returns — {asset}", fontsize=26)
    ax.set_xlabel("Date", fontsize=20)
    ax.set_ylabel("Gross cumulative return  (1.0 = start)", fontsize=20)
