...
raw = pd.read_csv(os.path.join(_DATA_DIR, "assets_yf_data.csv"), header=[0, 1], index_col=0, skiprows=[2])
...
# ── 5. Load VIX ───────────────────────────────────────────────────────────────
print("Loading VIX...")
vix = pd.read_excel(os.path.join(_DATA_DIR, "VIX.xlsx"), sheet_name="Daily, Close")
...
surp = pd.read_csv(os.path.join(_DATA_DIR, "macro_surprise_panel_fedincl.csv"), index_col=0, parse_dates=True)
...
# ── 10. Save ──────────────────────────────────────────────────────────────────
daily.to_csv(os.path.join(_DATA_DIR, "merged_daily_panel_fedincl_nextday.csv"))
ann.to_csv(os.path.join(_DATA_DIR, "merged_announcement_panel_fedincl_nextday.csv"))
print(f"\nSaved:")
print(f"  {_DATA_DIR}/merged_daily_panel_fedincl_nextday.csv")
print(f"  {_DATA_DIR}/merged_announcement_panel_fedincl_nextday.csv")
