...
# ── Load predictions ──────────────────────────────────────────────────────────
pred_val  = pd.read_csv("outcomes/y_pred_val.csv",  index_col=0, parse_dates=True)
pred_test = pd.read_csv("outcomes/y_pred_test.csv", index_col=0, parse_dates=True)

# ── Load actuals ──────────────────────────────────────────────────────────────
actuals = pd.read_csv("merged_announcement_panel_fedincl_nextday.csv",
...
# ── Save ──────────────────────────────────────────────────────────────────────
pearson_val.to_csv("outcomes/eval_pearson_val.csv")
pearson_test.to_csv("outcomes/eval_pearson_test.csv")
hitrate_val.to_csv("outcomes/eval_hitrate_val.csv")
hitrate_test.to_csv("outcomes/eval_hitrate_test.csv")
pct_pos_val.to_csv("outcomes/eval_pct_positive_val.csv")
pct_pos_test.to_csv("outcomes/eval_pct_positive_test.csv")
...
print(f"\nSaved: outcomes/eval_pearson_val.csv")
print(f"Saved: outcomes/eval_pearson_test.csv")
print(f"Saved: outcomes/eval_hitrate_val.csv")
print(f"Saved: outcomes/eval_hitrate_test.csv")
print(f"Saved: outcomes/eval_pct_positive_val.csv")
print(f"Saved: outcomes/eval_pct_positive_test.csv")
