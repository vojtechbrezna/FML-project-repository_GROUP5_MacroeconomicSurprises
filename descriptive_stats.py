...
# ── 1. ASSETS ────────────────────────────────────────────────────────────────
panel = pd.read_csv("merged_daily_panel_fedincl_nextday.csv", parse_dates=["date"])
...
asset_stats.to_csv("outcomes/desc_stats_assets.csv", index=False, float_format="%.6f")
print("Saved: outcomes/desc_stats_assets.csv")
print(asset_stats.to_string(index=False))


# ── 2. SURPRISES + VIX ───────────────────────────────────────────────────────
surprises_raw = pd.read_csv("macro_surprises_final_fedincl.csv", encoding="utf-8-sig")
...
surp_stats.to_csv("outcomes/desc_stats_surprises_vix.csv", index=False, float_format="%.6f")
print("\nSaved: outcomes/desc_stats_surprises_vix.csv")
